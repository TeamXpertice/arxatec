...
class CaseController
{
    ...
    public function add_case($case_name, $expediente_number, $description, $status, $client_dni, $lawyer_dni)
    {
        return $this->case_model->insert_case($case_name, $expediente_number, $description, $status, $client_dni, $lawyer_dni);
    }
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['action']) && $_POST['action'] == 'add') {
        ...
        $expediente_number = $_POST['expediente_number'];
        ...
        $success = $case_controller->add_case($case_name, $expediente_number, $description, $status, $client_dni, $lawyer_dni);
