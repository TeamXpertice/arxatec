...
$controller = new LawyerController($connection);

// Procesar el formulario y obtener el mensaje de resultado
$formMessage = $controller->handleLawyerFormSubmission();
?>
    ...
    <div class="col-xxl">
        <div class="card mb-6 mt-6">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0">Registro de Nuevo Abogado - ArxaTEC</h5>
                <small class="text-muted float-end">Completa los datos para registrar un abogado</small>
            </div>
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="specialty" name="specialty" placeholder="Ingresa la especialidad del abogado" required>
                    </div>
                    <div class="mb-3">
                        <label for="lawyer_license" class="form-label">Cédula de Colegiatura</label>
                        <input type="text" class="form-control" id="lawyer_license" name="lawyer_license" placeholder="Ingresa la cédula de colegiatura" required>
                    </div>
